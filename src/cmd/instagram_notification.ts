...
export const command: string = 'ig-notification <username>'
export const desc: string = 'Get notification from <username> latest post that we subscribe'
...
const poll = async function(interval: number, timeout: number, cb: Function) {
